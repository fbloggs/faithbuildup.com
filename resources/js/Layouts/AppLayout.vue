<template>
    <div class="min-h-screen bg-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <NavLink v-if="!quizdone" :href="route('quizzes.show', {id: 1})" :active="route().current('quizzes.show')">
                                Faith Balance Quiz
                            </NavLink>

                            <NavLink v-if="quizdone" :href="route('quizzes.results', {id: 1})" :active="route().current('quizzes.results')">
                                Faith Balance Results
                            </NavLink>
                            <NavLink :href="route('timelines.show')" :active="route().current('timelines.show')">
                                Faith Time Line
                            </NavLink>

                            <NavLink v-if="$page.props.auth.user.current_team_id == 1" :href="route('users.index')" :active="route().current('users.index')">
                                Users
                            </NavLink>
                        </div>
                    </div>
        ...
        <!-- Modal Portal Target for Vue 3 Teleport -->
